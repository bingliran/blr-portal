package com.blr19c.portal.modules.user.admin.entity
...
open class AdminUser : BaseUser {
    ...
    constructor(id: Long?, account: String?, nickName: String?, email: String?, password: String?, createTime: LocalDateTime?) {
        this.id = id
        this.account = account
        this.nickName = nickName
        this.email = email
